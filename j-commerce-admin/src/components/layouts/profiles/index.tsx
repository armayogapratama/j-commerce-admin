...
export default function ProfileBars() {
  ...
  return (
    <div className="w-full flex flex-row items-center justify-between">
      <div
        className={`pl-20 flex flex-row justify-center items-center gap-x-3`}>
        <Link
          href={"/dashboard"}
      ...
      <div
        ...
        <div className="w-10 h-10 rounded-full bg-neutral-50"></div>
        <span className="text-[14px] font-semibold text-white">Person</span>
      </div>
